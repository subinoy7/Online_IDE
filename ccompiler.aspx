<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ccompiler.aspx.cs" Inherits="ccomplier"  ValidateRequest="false"%>
...
<head runat="server">
    ...
    <script src="src/theme-github.js" type="text/javascript"></script>
    <script src="src/mode-c_cpp.js" type="text/javascript" charset="utf-8"></script>
    <script src="./js/c_ace.js" type="text/javascript"></script>
